                        ...
                        <div class="row">
                            <form method="post">
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <button type="submit" name="op" value="div" class="btn col s2 offset-s1 light-blue darken-2"> Divi </button>
                                    <button type="submit" name="op" value="mul" class="btn col s2 offset-s1 green lighten-1"> Mult </button>
                                    <button type="submit" name="op" value="sub" class="btn col s2 offset-s1 red lighten-1"> Subt </button>
                                </div>
